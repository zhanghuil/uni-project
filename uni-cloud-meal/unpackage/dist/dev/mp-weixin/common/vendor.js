...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"uni-cloud-meal","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!**********************************************!*\
  !*** E:/HBuilderX/uni-cloud-meal/pages.json ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!**************************************************!*\
  !*** E:/HBuilderX/uni-cloud-meal/store/index.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    setCompanyTit: function setCompanyTit(state, value) {
      state.companyName = value;
    },
    setPhoneInfo: function setPhoneInfo(state, value) {
...
/* 13 */
/*!***************************************************!*\
  !*** E:/HBuilderX/uni-cloud-meal/services/api.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default =
{
  ...
  getCompany: function getCompany(data) {//根据Id获取单位信息
    return api.baseRequest('/api/Company/' + _index.default.state.companyID, 'GET', data);
  },
  getDept: function getDept(data) {//根据医院Id获取部门信息
    return api.baseRequest('/api/Dept', 'GET', data);
  },
  wechatphone: function wechatphone(data) {//职工微信手机号验证
    return api.baseRequest('/api/Staff/auth/wechatphone', 'POST', data);
  },
  phoneStaff: function phoneStaff(data) {//职工姓名&部门&手机&验证码验证
    return api.baseRequest('/api/Staff/auth/phone', 'POST', data);
  },
  StaffName: function StaffName(data) {//职工补充姓名部门
    return api.baseRequest('/api/Staff', 'PUT', data);
  },
  wechatphoneP: function wechatphoneP(data) {//患者微信手机号验证
    return api.baseRequest('/api/Patient/auth/wechatphone', 'POST', data);
  },
  phonePatient: function phonePatient(data) {//患者手机号验证码验证
    return api.baseRequest('/api/Patient/auth/phone', 'POST', data);
  },
  smscode: function smscode(data) {//获取验证码
  ...
  storeAll: function storeAll(data) {//全部门店列表
    return api.baseRequest('/api/Store', 'GET', data);
  },
  storeOften: function storeOften(data) {//获取经常光顾门店列表
    return api.baseRequest('/api/Store/fond', 'GET', data);
  },
  storeLocation: function storeLocation(data) {//门店医院区域位置
    return api.baseRequest('/api/Address/district', 'GET', data);
  },
  storeDistrict: function storeDistrict(data) {//获取不同区域门店列表
    return api.baseRequest('/api/Store/district', 'GET', data);
  },


  // 门店主页
  storeInfo: function storeInfo(data) {//门店信息详情
    return api.baseRequest('/api/Store/' + data, 'GET', data);
  },
  storeMenu: function storeMenu(data) {//根据日期获取菜单
...
/* 14 */
/*!*******************************************************!*\
  !*** E:/HBuilderX/uni-cloud-meal/services/request.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _md = _interopRequireDefault(__webpack_require__(/*! ../common/md5.js */ 16));


var _index = _interopRequireDefault(__webpack_require__(/*! ../store/index.js */ 11));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //md5加密
// 同时发送异步代码的次数，防止一次点击中有多次请求，用于处理
var ajaxTimes = 0; //参数MD5加密
function encryption(timestamp, caller, callSource) {
  var authCode = '';
  var str = [timestamp, caller, callSource].map(authCodeStr).join('_');
  authCode = _md.default.hexMD5(str);
  // console.log(str)
...
var baseRequest = function baseRequest(url, method, data) {
  ...
  var tokenValue = uni.getStorageSync('token') || '';
    ...
    uni.request({
      ...
      success: function success(res) {
        ...
        if (res.statusCode === 200) {
          ...
          var companyID = _index.default.state.companyID;
          if (!companyID) {
            return uni.reLaunch({
...
/* 15 */
/*!******************************************************!*\
  !*** E:/HBuilderX/uni-cloud-meal/services/config.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 16 */
/*!*************************************************!*\
  !*** E:/HBuilderX/uni-cloud-meal/common/md5.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
